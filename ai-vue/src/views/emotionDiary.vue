<template>
    <div class="emotionDiary-container">
        ...
        <div class="content">
            ...
            <!-- 历史记录 -->
            <div class="diary-card" v-if="diaryList.length > 0">
                <div class="title">我的日记</div>
                <div class="diary-history">
                    <div v-for="d in diaryList" :key="d.id" class="diary-item">
                        <div class="diary-item-header">
                            <span class="diary-date">{{ d.diaryDate }}</span>
                            <el-tag size="small" v-if="d.dominantEmotion">{{ d.dominantEmotion }}</el-tag>
                            <span class="diary-score">心情 {{ d.moodScore }}/10</span>
                        </div>
                        <div class="diary-item-body">{{ d.diaryContent || d.emotionTriggers || '（无文字内容）' }}</div>
                        <div class="diary-item-meta" v-if="d.sleepQuality || d.stressLevel">
                            睡眠 {{ d.sleepQuality }}/5 · 压力 {{ d.stressLevel }}/5
                        </div>
                    </div>
                </div>
            </div>
...
<script setup>
    ...
    import { addEmotionDiary, getMyDiaryList } from '@/api/frontend'
